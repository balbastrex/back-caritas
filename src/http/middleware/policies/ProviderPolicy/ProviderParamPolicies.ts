...
const providerParamPolicies = (req: Request, res: Response, next: Function) => {
  console.log('==> ProviderParamsPolicy')
  ...
  if (res.locals.profileId === UserProfiles.DIRECTOR_ECONOMATO || res.locals.profileId === UserProfiles.COMPRAS) {
    res.locals.findQuery = {
      id: req.params.id,
...
export default providerParamPolicies;
